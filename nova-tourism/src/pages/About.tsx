    ...
    <div className="min-h-screen bg-white pt-20">
      ...
      <section className="py-20 px-6 text-center bg-gray-50 border-b border-gray-100">
        <div className="absolute inset-0" style={{
          background: 'radial-gradient(ellipse at center, rgba(230,50,40,0.07) 0%, transparent 70%)'
        }} />
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} className="relative max-w-4xl mx-auto">
          <p className="text-nova-orange text-sm font-semibold tracking-widest uppercase mb-3">Our Story</p>
          <h1 className="text-5xl md:text-7xl font-black text-gray-900 mb-6">
            About <span className="nova-text-gradient">NOVA</span>
          </h1>
          <p className="text-gray-600 text-xl leading-relaxed">
            Pune's most trusted tourism & events company — turning every trip into a story worth telling since 2019.
          </p>
        </motion.div>
      </section>
      ...
      <section className="max-w-7xl mx-auto py-16 grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
        <motion.div initial={{ opacity: 0, x: -40 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
          <div className="relative rounded-3xl overflow-hidden aspect-square border border-orange-500/20">
            <SlideIn from="left">
            <div className="relative rounded-3xl overflow-hidden aspect-square border-orange-100">
              <img
        ...
        <motion.div initial={{ opacity: 0, x: 40 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
          ...
          <p className="text-gray-600 leading-relaxed mb-4">
            Founded in 2019 in Pune, NOVA Tourism & Events started with a simple mission — to make travel accessible, safe, and genuinely memorable for everyone.
          </p>
          <p className="text-gray-600 leading-relaxed mb-6">
            ...
            <span className="text-nova-orange font-semibold">Where Every Journey Becomes a Memory.</span>
          </p>
          </SlideIn>
              ...
              <StaggerGrid className="grid grid-cols-3 gap-3 mb-5">
                {[['5000+', 'Travelers'], ['50+', 'Destinations'], ['7+', 'Years']].map(([val, lab]) => (
                  <StaggerItem key={lab} variants={staggerItemVariants}>
                    <div className="text-center bg-white border border-orange-100 rounded-xl py-4 px-2">
                      <div className="text-2xl font-black leading-none mb-1"
                        style={{ background: 'linear-gradient(135deg, #e63228, #f7941d)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
                        {val}
                      </div>
                      <div className="text-gray-400 text-xs">{lab}</div>
                      <div className="w-5 h-1 rounded-full mx-auto mt-2" style={{ background: 'linear-gradient(90deg, #e63228, #f7941d)' }} />
                    </div>
                  </StaggerItem>
                ))}
              </StaggerGrid>
        ...
        <div className="flex flex-wrap gap-2">
          {[
            ...
            <div key={text} className="flex items-center gap-1.5 text-xs text-gray-500 bg-gray-50 border border-gray-100 rounded-full px-3 py-1.5">
              <Icon size={12} className="text-nova-orange" />
              {text}
            </div>
          ))}
        </div>
      ...
      <section className="py-16 px-6 bg-orange-50 border-y border-orange-100"
        style={{ background: 'linear-gradient(135deg, rgba(230,50,40,0.05), rgba(247,148,29,0.05))' }}>
        <div className="max-w-4xl mx-auto">
          ...
          >
            <p className="text-nova-orange text-sm font-semibold tracking-widest uppercase mb-3">Leadership</p>
            <h2 className="text-4xl font-black text-gray-900">
              Meet the <span className="nova-text-gradient">Founder</span>
            </h2>
          </motion.div>
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="flex flex-col md:flex-row items-center gap-8 bg-white border border-orange-100 rounded-3xl p-8 max-w-2xl mx-auto shadow-sm"
          >
            {/* Photo placeholder */}
            <div className="shrink-0">
              <div
                className="w-36 h-36 rounded-2xl overflow-hidden border-2 border-orange-500/40"
            ...
            <div className="text-center md:text-left">
              ...
              <p className="text-nova-orange font-semibold mb-4">Founder & CEO</p>
              ...
              <div className="flex gap-3 justify-center md:justify-start">
                ...
                <a href="mailto:novatourism.info@gmail.com"
                  className="flex items-center gap-2 px-4 py-2 rounded-full text-sm border border-orange-500/30 text-orange-400 hover:bg-orange-500/10 transition-colors">
                  ✉️ Email
                </a>
              </div>
            </div>
      ...
      <section className="py-16 px-6 max-w-7xl mx-auto bg-white">
        <motion.h2 initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }}
          ...
          Why Travelers <span className="nova-text-gradient">Choose Us</span>
        </motion.h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            ...
            <motion.div
              ...
              className="bg-white border border-gray-100 hover:border-orange-200 rounded-2xl p-6 text-center transition-all hover:-translate-y-2 hover:shadow-lg"
            >
